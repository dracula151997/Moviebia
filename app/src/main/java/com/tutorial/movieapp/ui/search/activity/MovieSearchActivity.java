...
public class MovieSearchActivity extends BaseActivity implements SearchView.OnQueryTextListener, RecyclerItemClickListener.OnRecyclerViewItemClickListener
{
    ...
    {
        viewModel.getMoviesLiveData().observe(this, resource ->
        {
    ...
    private void updateUI(List<MovieEntity> data)
    {
        ...
        {
            MovieEntity item = adapter.getItem(position);
    ...
    private void updateBackground(String posterPath)
    {
        binding.backgroundSwitcher.updateCurrentBackground(posterPath);
    }
