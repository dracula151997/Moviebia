package com.tutorial.movieapp.ui.custom;
...
public class CollectionPicker extends LinearLayout
{
    ...
    private final List<String> genresList = Arrays.asList("#febf9b", "#f47f87", "#6ac68d", "#fbe0a5");
    ...
    public CollectionPicker(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        this.useRandomColor = typeArray.getBoolean(R.styleable.CollectionPicker_cp_randomColor, false);
        typeArray.recycle();
